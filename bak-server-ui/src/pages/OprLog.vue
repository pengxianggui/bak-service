<template>
  <div class="opr-log">
    <fast-table :option="tableOption">
      ...
      <fast-table-column prop="categoryName" label="数据品类名称" width="160" first-filter/>
      ...
      <fast-table-column-switch prop="success" label="是否成功"/>
      <fast-table-column-file prop="fileUrl" label="文件" width="150"/>
      <fast-table-column-switch prop="expired" label="是否失效"/>
      <fast-table-column prop="cond" label="where条件" width="100"/>
      <fast-table-column-textarea prop="msg" label="日志" width="150" :show-overflow-tooltip="true"/>
